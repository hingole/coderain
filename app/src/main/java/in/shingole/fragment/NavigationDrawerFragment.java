...
/**
 * Fragment used for managing interactions for and presenta tion of a navigation drawer.
...
public class NavigationDrawerFragment extends BaseFragment {
  ...
  private void initNavigationListeners() {
    navigation.setNavigationListListener(new LeftNavigationWidget.NavigationListener() {
      ...
      public void intentsSelected(LeftNavigationWidget.NavigationType navType) {
        ...
        if (mCallbacks != null) {
          mCallbacks.onNavigationDrawerItemSelected(navType);
        }
      }
    });
  }
  ...
  public static interface NavigationDrawerCallbacks {
    ...
    LeftNavigationWidget.NavigationType getActiveNavigationType();

    /**
     * Called when an item in the navigation drawer is selected.
     */
    void onNavigationDrawerItemSelected(LeftNavigationWidget.NavigationType navigationType);
  }
}
